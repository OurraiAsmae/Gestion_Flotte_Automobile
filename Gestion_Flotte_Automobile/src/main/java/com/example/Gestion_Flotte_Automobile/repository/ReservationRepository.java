...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
        ...
        java.util.List<Reservation> findByDateDebutBetween(java.time.LocalDateTime start, java.time.LocalDateTime end);
        ...
        java.util.Optional<Reservation> findByVoitureIdAndStatut(Long voitureId,
                        com.example.Gestion_Flotte_Automobile.enums.StatutReservation statut);
}
